...
public sealed partial class RoleTimeExemptionPanel : DefaultWindow
{
    ...
    private readonly ISawmill _playtimeExemptionPanelSawmill;
    ...
    public RoleTimeExemptionPanel()
    {
        ...
        _playtimeExemptionPanelSawmill = _logManager.GetSawmill("admin.playtimeexemptionpanel");
        ...
        Button roleGroupCheckbox)
    {
        ...
        {
            _playtimeExemptionPanelSawmill.Error(
    ...
    public void UpdatePanelState(RoleTimeExemptionPanelEuiState state)
    {
        ...
        var selectedIds = state.JobExemptions.Select(antagPrototype => antagPrototype.Id).ToHashSet();
        selectedIds.UnionWith(state.AntagExemptions.Select(antagPrototype => antagPrototype.Id));
